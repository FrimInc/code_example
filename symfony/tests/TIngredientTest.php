...
class TIngredientTest extends TestCase
{
    ...
    {
        $obIngredient = new TIngredient();
        $this->expectExceptionCode(ExceptionFactory::ENTITY_NAME_EMPTY['code']);
    ...
    public function testSetNameShort(): void
    {
        ...
        $obIngredient = new TIngredient();
        $this->expectExceptionCode(ExceptionFactory::ENTITY_NAME_SHORT['code']);
        $obIngredient->setName($strName);
    }
    ...
    public function testCanDeleteOK(): void
    {
        ...
        $this->assertSame(ExceptionFactory::NO_ACCESS_EDIT['code'], $obException->getCode());
